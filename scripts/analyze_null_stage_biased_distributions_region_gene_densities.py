...
#E: Full null, P(N>=O) = 0.003
#E: Non 0 null, P(N>=O) = 0.003121748178980229
#L1: Full null, P(N>=O) = 0.004
#L1: Non 0 null, P(N>=O) = 0.004784688995215311
#L2: Full null, P(N>=O) = 0.051
#L2: Non 0 null, P(N>=O) = 1.0
#L3: Full null, P(N>=O) = 0.078
#L3: Non 0 null, P(N>=O) = 1.0
#D: Full null, P(N>=O) = 0.0
#D: Non 0 null, P(N>=O) = 0.0
#L4: Full null, P(N>=O) = 0.004
#L4: Non 0 null, P(N>=O) = 0.004214963119072708
#A: Full null, P(N>=O) = 0.015
#A: Non 0 null, P(N>=O) = 0.05791505791505792
...
ax1.set_title('Embryo: P(N$\geq$O) = 0.003', fontsize=14, multialignment='center')
ax2.set_title('L1: P(N$\geq$O) = 0.005', fontsize=14, multialignment='center')
...
ax6.set_title('L4: P(N$\geq$O) = 0.004', fontsize=14, multialignment='center')
ax7.set_title('Adult: P(N$\geq$O) = 0.058', fontsize=14, multialignment='center')

plt.tight_layout()
plt.savefig('../figures/cluster_regions_gene_densities_null_vs_obs.pdf', bbox_inches='tight')
