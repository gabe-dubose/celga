...
#L2: Full null, P(N>=O) =1.0
#L2: Non 0 null, P(N>=O) = 1.0
#L3: Full null, P(N>=O) =0.0
#D: Full null, P(N>=O) =0.0
#D: Non 0 null, P(N>=O) = 0.0
...
ax3.set_title('L2: P(N$\geq$O) = 1', fontsize=14, multialignment='center')
ax4.set_title('L3: P(N$\geq$O) = 1', fontsize=14, multialignment='center')
ax5.set_title('Dauer: P(N$\geq$O) < 0.001', fontsize=14, multialignment='center')
...
plt.tight_layout()
plt.savefig('../figures/cluster_regions_frequencies_null_vs_obs.pdf')
