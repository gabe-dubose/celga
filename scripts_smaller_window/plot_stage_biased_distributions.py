...
fig, [ax1,ax2,ax3,ax4, ax5,ax6,ax7] = plt.subplots(1, 7, figsize=(18, 3), sharey=False)
...
sns.histplot(data=L3_biased, x='density', ax=ax3, color=colors[3], alpha=1, discrete=True, element="step")
...
ax4.set_title('L3-biased', fontsize=15)
...
ax6.set_xticks([3,4,5])
ax7.set_xticks([3,4,5])
