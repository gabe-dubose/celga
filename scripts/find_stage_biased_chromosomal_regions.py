...
# 2) For each window, a random sample of 1000 other tau values is taken. This serves
...
def plot_colored_bars(ax, window_start, cohens_d, stage_index, width=100000, label=None):
